...
Generates diagnostic plots of energy and angular momentum vs. time, including zoomed error panels against the analytical value reference line. Outputs PNGs under `output/`.
